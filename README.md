...
**Open‑source, AI‑powered photonic integrated circuit (PIC) design platform**
...
PhotonicForge provides a **differentiable geometry engine** for photonic layout design and an **export pipeline to GDSII**. The current focus (Phase 1) includes:
- SDF‑based 2‑D geometry primitives (waveguides, bends, couplers)
...
├── solvers/            # FDTD wrappers (Meep placeholder)
├── pdk/                # Process design kit definitions
├── optimize/           # Optimization utilities (future work)
└── ui/                 # Streamlit UI (future work)
```

---

## Learning Path (Completed)
- **Week 0** – Repository setup, CI/CD, testing infrastructure
- **Week 1** – Geometry core (SDF primitives, unit tests)
- **Week 2** – GDS export, basic PDK, verification tests
...
## Project Status
- **Current:** Week 2 – GDS export and PDK are functional.
- **Next:** Integrate an FDTD solver (Meep) and expose photonic metrics.

---

## Contributing
We welcome contributions! Please read the [CONTRIBUTING.md](CONTRIBUTING.md) first.
